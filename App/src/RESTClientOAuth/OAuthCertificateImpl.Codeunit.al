codeunit 73288 TKAOAuthCertificateImpl
{
    Access = Internal;
    ...
    var
        ...
        ThumbprintHex: Text;
    begin
        X509Certificate2.GetCertificateThumbprint(Certificate, PrivateKey, ThumbprintHex);
...
#pragma warning disable LC0010 // Case statement, complexity is OK
